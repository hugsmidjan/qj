...
o.spec('Memoize', () => {
    ...
    o('Memoizes 2 arguments', () =>  {
        const _decimalize = o.spy((a, b) => a*10 + b);
    ...
    o('Memoizes 3 arguments', () => {
        const _decimalize = o.spy((a, b, c) => a*100 + b*10 + c);
        const decimalize = memoize(_decimalize);
        decimalize(1, 2, 3);
    ...
    o('Memoizes 5 arguments', () => {
        const _decimalize = o.spy((a, b, c, d, e) => a*10000 + b*1000 + c*100 + d*10 + e);
        const decimalize = memoize(_decimalize);
    ...
    o('Memoizes (...arg) functions with multiArg param', () => {
        const _decimalize = o.spy((...args) => args.reverse().reduce((acc,arg,i) => acc+arg*Math.pow(10,i), 0));
    ...
    o('Memoizes (n, ...arg) functions with multiArg', () => {
        const _decimalize = o.spy((n, ...args) => n*Math.pow(10,args.length) + args.reverse().reduce((acc,arg,i) => acc+arg*Math.pow(10,i), 0));
        const decimalize = memoize(_decimalize, true);
        decimalize(1, 2, 3);
        o( decimalize(1, 2, 3) ).equals(123);
        o( _decimalize.callCount ).equals(1);
